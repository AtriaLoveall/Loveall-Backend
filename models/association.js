...
import Transaction from './transaction.model.js'; // Import the Transaction model
...
// Business and Transaction association
Business.hasMany(Transaction, { foreignKey: 'business_id', onDelete: 'CASCADE' });
Transaction.belongsTo(Business, { foreignKey: 'business_id', onDelete: 'CASCADE' });
