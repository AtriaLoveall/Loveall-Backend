...
import { BusinessTransactionController, exportCSV, downloadInvoices } from '../controllers/BusinessTransactionController.js';
import businessFeedbackController from '../controllers/businessFeedbackController.js';
...
router.get('/transactions', BusinessTransactionController);
router.get('/export-csv', exportCSV);
router.get('/download-invoices', downloadInvoices);
router.get('/feedbacks', businessFeedbackController);
